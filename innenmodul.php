<?php
// ----- Innenmodul ----- 
$temp_innen = number_format($array["body"]["devices"][0]["dashboard_data"]["Temperature"], 1, ".", "");
$temp_max_innen = number_format($array["body"]["devices"][0]["dashboard_data"]["max_temp"], 1, ".", "");
$temp_min_innen = number_format($array["body"]["devices"][0]["dashboard_data"]["min_temp"], 1, ".", "");
$laerm_innen = $array["body"]["devices"][0]["dashboard_data"]["Noise"];
$luft_innen = $array["body"]["devices"][0]["dashboard_data"]["Humidity"];
$druck_innen = number_format($array["body"]["devices"][0]["dashboard_data"]["Pressure"], 1, ".", "");
$co2_innen = $array["body"]["devices"][0]["dashboard_data"]["CO2"];
...
$wifi = $array["body"]["devices"][0]["wifi_status"];
$firmware_innen = $array["body"]["devices"][0]["firmware"];
$name_innen = $array["body"]["devices"][0]["module_name"];
...
$last_status_store = $array["body"]["devices"][0]["last_status_store"];
$last_status_store =  date('H:i', $last_status_store); 					// Unix Timestamp in Uhrzeit wandeln
$last_upgrade = $array["body"]["devices"][0]["last_upgrade"];
